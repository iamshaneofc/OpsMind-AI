  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-3 justify-self-start">
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary shadow-[0_0_10px_rgba(79,70,229,0.1)]">
          <Sparkles size={18} />
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-end gap-4 justify-self-end">
        <div className="hidden sm:flex items-center gap-2 text-[11px] font-medium uppercase tracking-wider text-muted-foreground px-2 py-1">
          <div className="h-1.5 w-1.5 rounded-full bg-success animate-pulse shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
          Systems Online
        </div>
